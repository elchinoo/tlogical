...
PG_BIN_DIR="/usr/lib/postgresql/15"
...
$EC "rm -Rf ${PG_HOME}/pgsql/*"
$EC "mkdir -p ${PG_HOME}/pgsql"
...
host    replication     replicator     ${IP_PRIMARY}/32         trust
host    replication     replicator     ${IP_REPLICA}/32          trust
